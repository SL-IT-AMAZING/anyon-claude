...
// ===== Ownuun Reviewer =====
// UI 캡쳐 기반 엄격한 UX/UI 검증 + 완전성 검증

const WORKFLOW_CONFIG = `# Ownuun Reviewer - 엄격한 UX/UI 검증
name: "ownuun-reviewer"
...
const INSTRUCTIONS = `# Ownuun Reviewer 지시사항
...
<action>execution-progress.md에서 현재 SubWave 확인</action>

<action>리뷰 대상 파일 수집:
  - 이번 SubWave에서 생성/수정된 파일 목록
...
\`\`\`
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  🔍 Ownuun Reviewer - {{current_subwave}}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
\`\`\`bash
git add .
git commit -m "fix({{current_subwave}}): UI/완전성 이슈 수정
...
export const OWNUUN_REVIEWER_PROMPT = `
# Workflow Execution
...
export const OWNUUN_REVIEWER_METADATA = {
  id: 'ownuun-reviewer',
